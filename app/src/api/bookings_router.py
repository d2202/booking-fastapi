...
from app.src.schemas.bookings_schema import GetAllBookingsResponse, Booking, PostAddNewBooking
...
@router.post("/add")
async def post_add_booking(request_data: PostAddNewBooking, user: Users = Depends(get_current_user)):
